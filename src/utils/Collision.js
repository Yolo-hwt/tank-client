//全局变量引入
import { DIRECT, TAGS } from "../hook/globalParams";
 ...
 */
export const CheckIntersect = function (object1, object2, overlap) {
	//    x-轴                      x-轴
	//  A1------>B1 C1              A2------>B2 C2
	//  +--------+   ^              +--------+   ^
 ...
 */
export const tankMapCollision = function (tank, gameInstance) {
 ...
 * @param mapobj 地图对象
 */
export const bulletMapCollision = function (bullet, gameInstance) {
	let mapobj = gameInstance.map;
	let tileNum = 0;//需要检测的tile数
	let rowIndex = 0;//map中的行索引
	let colIndex = 0;//map中的列索引
