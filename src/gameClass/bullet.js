//全局变量引入
import { POS, DIRECT, PICTURES, BULLET_TYPE, CRACK_TYPE, SOUNDS } from "@/hook/globalParams";
...
import { CheckIntersect, bulletMapCollision } from "../utils/Collision"
export const Bullet = function (owner, type, dir, gameInstance) {
